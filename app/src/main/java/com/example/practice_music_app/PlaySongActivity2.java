...
public class PlaySongActivity2 extends AppCompatActivity {
    ...
    private SongCollection2 songCollection2 = new SongCollection2();
    private SongCollection2 originalSongCollection2 = new SongCollection2();

    List<Song> shuffleList = Arrays.asList(songCollection2.songs);
    ...
    public void displaySongBasedOnIndex(int selectIndex){
        ...
        Song song = songCollection2.getCurrentSong(selectIndex);
        title = song.getTitle();
        ...
        player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(repeatFlag){
                    ...
                    btnPlayPause.setImageResource(R.drawable.play);
                    //Toast.makeText(PlaySongActivity2.this, "Song ended", Toast.LENGTH_SHORT).show();
    ...
    public void shuffleSong(View view) {
        ...
        if(shuffleFlag){
            ...
            shuffleList.toArray(songCollection2.songs);
