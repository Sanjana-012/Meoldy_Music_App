...
public class PlaySongActivity3 extends AppCompatActivity {
    ...
    private SongCollection3 songCollection3 = new SongCollection3();
    private SongCollection3 originalSongCollection3 = new SongCollection3();

    List<Song> shuffleList = Arrays.asList(songCollection3.songs);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //goes back to the 1st activity play song page
    ...
    public void displaySongBasedOnIndex(int selectIndex){
        ...
        Song song = songCollection3.getCurrentSong(selectIndex);
        title = song.getTitle();
        ...
        player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(repeatFlag){
                    ...
                    btnPlayPause.setImageResource(R.drawable.play);
                    //Toast.makeText(PlaySongActivity3.this, "Song ended", Toast.LENGTH_SHORT).show();
    ...
    public void shuffleSong(View view) {
        ...
        if(shuffleFlag){
            ...
            shuffleList.toArray(songCollection3.songs);
