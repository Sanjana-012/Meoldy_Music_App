...
public class PlaySongActivity4 extends AppCompatActivity {
    ...
    private SongCollection4 songCollection4 = new SongCollection4();
    private SongCollection4 originalSongCollection4 = new SongCollection4();

    List<Song> shuffleList = Arrays.asList(songCollection4.songs);
    ...
    public void displaySongBasedOnIndex(int selectIndex){
        ...
        Song song = songCollection4.getCurrentSong(selectIndex);
        title = song.getTitle();
        ...
        player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(repeatFlag){
                    ...
                    btnPlayPause.setImageResource(R.drawable.play);
                    //Toast.makeText(PlaySongActivity4.this, "Song ended", Toast.LENGTH_SHORT).show();
    ...
    public void playNext(View view) {
        currentIndex = songCollection4.getNextSong(currentIndex);
    ...
    public void playPrevious(View view) {
        currentIndex = songCollection4.getPrevSong(currentIndex);
        //Toast.makeText(this, "The current index is now " + currentIndex, Toast.LENGTH_LONG).show();
        displaySongBasedOnIndex(currentIndex);
        playSong(fileLink);
        btnPlayPause.setImageResource(R.drawable.pause);
    ...
    public void shuffleSong(View view) {
        ...
        if(shuffleFlag){
            ...
            songCollection4 = new SongCollection4();

        }else{
            //change graphic to the repeat on
            shuffleBtn.setBackgroundResource(R.drawable.shuffle_on);
            Collections.shuffle(shuffleList);
            shuffleList.toArray(songCollection4.songs);
